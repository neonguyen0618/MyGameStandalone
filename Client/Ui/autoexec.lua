...
--bat tat hien an obj tren mat dat
AddCommand("Alt+Space", "", "Switch([[showiteminfo]])")
AddCommand("Alt+Z", "", "Switch([[autoingame]])")
...
SetPhrase(0, "Cac ha o dau?:S")
SetPhrase(1, "Theo tai ha den day!:K")
