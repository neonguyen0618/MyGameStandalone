...
DataPara1=40
DataPara2=5
return GetData(Level, DataPara1, DataPara2)*3
end;

if (Level <= 20) then
DataPara1=120
DataPara2=5
return GetData(Level-10, DataPara1, DataPara2)*3
end;

if (Level <= 30) then
DataPara1=240
DataPara2=5
return GetData(Level-20, DataPara1, DataPara2)*3
end;

if (Level <= 40) then
DataPara1=360
DataPara2=5
return GetData(Level-30, DataPara1, DataPara2)*3
end;

if (Level <= 50) then
DataPara1=480
DataPara2=5
return GetData(Level-40, DataPara1, DataPara2)*3
end;

if (Level <= 60) then
DataPara1=600
DataPara2=5
return GetData(Level-50, DataPara1, DataPara2)*3
end;

if (Level <= 70) then
DataPara1=720
DataPara2=5
return GetData(Level-60, DataPara1, DataPara2)*3
end;

if (Level <= 80) then
DataPara1=800
DataPara2=5
return GetData(Level-70, DataPara1, DataPara2)*3
end;

if (Level <= 90) then
DataPara1=900
DataPara2=5
return GetData(Level-80, DataPara1, DataPara2)*3
end;

if (Level <= 100) then
DataPara1=1000
DataPara2=5
return GetData(Level-90, DataPara1, DataPara2)*3
end;
