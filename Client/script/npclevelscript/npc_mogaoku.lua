...
if (Level >=110) then
return GetData(100, Param1, Param2)
end;
return floor(Param1);
end;
...
DataPara1=1000
DataPara2=6
return GetData(Level-100, DataPara1, DataPara2)
end;

if (Level <= 120) then
DataPara1=1100
DataPara2=6
return GetData(Level-110, DataPara1, DataPara2)
end;

if (Level <= 130) then
DataPara1=1200
DataPara2=6
return GetData(Level-120, DataPara1, DataPara2)
end;

if (Level <= 140) then
DataPara1=1300
DataPara2=6
return GetData(Level-130, DataPara1, DataPara2)
end;

if (Level <= 150) then
DataPara1=1400
DataPara2=6
return GetData(Level-140, DataPara1, DataPara2)
end;

if (Level <= 160) then
DataPara1=1500
DataPara2=6
return GetData(Level-150, DataPara1, DataPara2)
end;

if (Level <= 170) then
DataPara1=1600
DataPara2=6
return GetData(Level-160, DataPara1, DataPara2)
end;

if (Level <= 180) then
DataPara1=1700
DataPara2=6
return GetData(Level-170, DataPara1, DataPara2)
end;

if (Level <= 190) then
DataPara1=1800
DataPara2=6
return GetData(Level-180, DataPara1, DataPara2)
end;

if (Level <= 200) then
DataPara1=1900
DataPara2=6
return GetData(Level-190, DataPara1, DataPara2)
end;
...
DataPara1=152
DataPara2=1.1
return floor(GetData(Level-100, DataPara1, DataPara2))
end;

if (Level <= 120) then
DataPara1=192
DataPara2=1.2
return floor(GetData(Level-110, DataPara1, DataPara2))
end;

if (Level <= 130) then
DataPara1=232
DataPara2=1.3
return floor(GetData(Level-120, DataPara1, DataPara2))
end;

if (Level <= 140) then
DataPara1=272
DataPara2=1.4
return floor(GetData(Level-130, DataPara1, DataPara2))
end;

if (Level <= 150) then
DataPara1=312
DataPara2=1.5
return floor(GetData(Level-140, DataPara1, DataPara2))
end;

if (Level <= 160) then
DataPara1=352
DataPara2=1.6
return floor(GetData(Level-150, DataPara1, DataPara2))
end;

if (Level <= 170) then
DataPara1=392
DataPara2=1.7
return floor(GetData(Level-160, DataPara1, DataPara2))
end;

if (Level <= 180) then
DataPara1=432
DataPara2=1.8
return floor(GetData(Level-170, DataPara1, DataPara2))
end;

if (Level <= 190) then
DataPara1=472
DataPara2=1.9
return floor(GetData(Level-180, DataPara1, DataPara2))
end;

if (Level <= 200) then
DataPara1=512
DataPara2=2
return floor(GetData(Level-190, DataPara1, DataPara2))
end;
