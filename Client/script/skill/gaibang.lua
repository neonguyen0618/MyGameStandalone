...
SKILLS={
	...
	feilong_zaitian={ --飞龙在天
		...
		skill_misslesform_v={{{1,1},{11,1},{12,2},{20,2}}},--1是线形，2是散形
		skill_param1_v={{{1,0},{11,0},{12,1},{20,1},{21,1}}},--散形开口大小
		skill_misslenum_v={{{1,1},{11,1},{12,2},{15,3},{19,4},{20,4},{21,4}}},--子弹数目
...
--		skill_showevent={{{1,0},{15,0},{15,4},{20,4}}},
	...
	tianxia_wugou={ --天下无狗
		...
		skill_misslesform_v={{{1,1},{11,1},{12,2},{20,2}}},--1是线形，2是散形
		skill_param1_v={{{1,0},{11,0},{12,1},{20,1},{21,1}}},--散形开口大小
		skill_misslenum_v={{{1,1},{11,1},{12,2},{15,2},{19,2},{20,3},{21,3}}},--子弹数目
		skill_attackradius={{{1,448},{20,448},{21,448}}},
