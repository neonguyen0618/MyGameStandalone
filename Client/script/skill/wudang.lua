...
SKILLS={
	...
	wudang_jianfa ={ --武当剑法
		addphysicsdamage_p={{{1,25},{20,315}},{{1,-1},{2,-1}},{{1,0},{2,0}}},
	...
	zuowang_wuwo={ --坐望无我
		manashield_p={{{1,25},{5,75},{20,99},{21,100},{22,100}},{{1,-1},{20,-1}}},
	...
	wuwo_wujian={ --无我无剑
		...
		stun_p={{{1,5},{20,25}},{{1,1},{20,10},{21,10}}},
