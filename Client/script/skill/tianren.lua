...
SKILLS={
	...
	tianren_daofa={ --天忍刀法
		addfiremagic_v={{{1,15},{20,275}},{{1,-1},{2,-1}}}
	},
	tianren_maofa={ --天忍矛法
		addphysicsdamage_p={{{1,15},{20,235}},{{1,-1},{2,-1}},{{1,3},{2,3}}},
	...
	tuishan_tianhai={ --推山填海
		...
		firedamage_v={
			[1]={{1,50},{20,450},{46,2000},{47,1500}},
			[3]={{1,50},{20,450},{46,2000},{47,1500}}
		},
		addskilldamage1={
			[1]={{1,362},{2,362}},
			[3]={{1,1},{20,115}}
