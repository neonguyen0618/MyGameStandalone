...
SKILLS={
	...
	xinyan={ --心眼
		addcolddamage_v={{{1,10},{30,80}},{{1,-1},{2,-1}}},
	...
	zhuixin_jian={ --追心箭
		physicsenhance_p={{{1,20},{20,285}}},
		seriesdamage_p={{{1,5},{20,30}}},
		poisondamage_v={{{1,3},{20,38}},{{1,60},{20,60}},{{1,10},{20,10}}},
	...
	xiaoli_feidao={ --小李飞刀
		seriesdamage_p={{{1,10},{20,50},{21,52}}},
		physicsenhance_p={{{1,50},{20,199},{25,344},{26,359}}},
		poisondamage_v={{{1,5},{20,15}},{{1,60},{20,60}},{{1,10},{20,10}}},
	...
	baoyu_lihua={ --暴雨梨花
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		physicsenhance_p={{{1,15},{15,200},{20,204}}},
	...
	jiugong_feixing={ --九宫飞星
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		physicsenhance_p={{{1,10},{15,100},{20,494}}},
		deadlystrike_p={{{1,10},{20,49}}},
