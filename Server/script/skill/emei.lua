...
SKILLS={
	...
	emei_jianfa={ --峨嵋剑法
		addphysicsdamage_p={{{1,15},{20,225}},{{1,-1},{2,-1}},{{1,0},{2,0}}},
		deadlystrikeenhance_p={{{1,6},{20,36}},{{1,-1},{2,-1}}}
	},
	emei_zhangfa={ --峨嵋掌法
		addcoldmagic_v={{{1,15},{20,615}},{{1,-1},{2,-1}}}
	},
	...
	sane_jixue={ --三峨霁雪
		skill_param1_v={{{1,0},{10,0},{11,1},{20,1},{21,1}}},
		physicsenhance_p={{{1,10},{15,200},{20,497}}},
		skill_misslenum_v={{{1,1},{10,1},{11,2},{19,2},{20,3},{21,3}}},
		skill_misslesform_v={{{1,1},{10,1},{11,2},{20,2}}},--1是线形，2是散形
	...
	fengshuang_suiying={ --风霜碎影
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		colddamage_v={
			[1]={{1,20},{15,750},{20,1570}},
			[3]={{1,30},{15,900},{20,1900}}
		},
		skill_eventskilllevel={{{1,1},{20,20}}},
		skill_cost_v={{{1,30},{20,65}}},
		skill_startevent={
	...
	jinding_foguang={ --金顶佛光
		colddamage_v={
			[1]={{1,10},{20,785},{21,1000}},
			[3]={{1,10},{20,785},{21,1000}},
		},
		seriesdamage_p={{{1,20},{20,60},{21,62}}},
	...
	emei120={ --峨嵋120级技能
		...
		skill_desc=
			function(level)
				return "以下衍生的光环技能等级取此技能和相应光环等级的最低者\n"
			end,
