...
SKILLS={
	...
	kunlun_daofa={ --昆仑刀法
		addphysicsdamage_p={{{1,35},{20,315}},{{1,-1},{2,-1}},{{1,1},{2,1}}},
	...
	kuangfeng_zhoudian={ --狂风骤电
		...
		missle_speed_v={{{1,28},{20,32},{21,30}}},
		skill_attackradius={{{1,448},{20,560},{21,560}}},
	...
	aoxue_xiaofeng={ --傲雪啸风
		...
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		lightingdamage_v={
			[1]={{1,39},{15,200},{20,773}},
			[3]={{1,39},{15,200},{20,773}}
		},
		stun_p={{{1,5},{20,20},{21,25}},{{1,1},{20,12},{21,12}}},
