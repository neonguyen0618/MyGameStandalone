...
SKILLS={
	...
	shaolin_daofa={ --少林刀法
		addphysicsdamage_p={{{1,25},{20,315}},{{1,-1},{2,-1}},{{1,1},{2,1}}},
		deadlystrikeenhance_p={{{1,5},{20,15,Conic}},{{1,-1},{2,-1}}}
	},
	shaolin_quanfa={ --少林拳法
		addphysicsdamage_p={{{1,25},{20,315}},{{1,-1},{2,-1}},{{1,9},{2,9}}},
		attackratingenhance_p={{{1,35},{20,275}},{{1,-1},{2,-1}}},
		deadlystrikeenhance_p={{{1,6},{20,45,Conic}},{{1,-1},{2,-1}}}
	},
	xinglong_buyu={ --行龙不雨
		physicsenhance_p={{{1,60},{20,445}}},
		magicenhance_p={{{1,1},{20,10}}},
colddamage_v={
			[1]={{1,10},{20,56},{25,200},{31,2000},{46,3000}},
			[3]={{1,10},{20,56},{25,200},{31,4000},{46,4000}}
		},
	...
	longzhao_huzhua={ --龙爪虎抓
		physicsenhance_p={{{1,120},{20,1042}}},
		seriesdamage_p={{{1,10},{20,50},{21,52}}},
		ignoredefense_p={{{1,9},{20,85},{21,86}}},
		stun_p={{{1,2},{20,10}},{{1,2},{20,10}}},
	...
	mohe_wuliang={ --摩诃无量
		...
		magicenhance_p={{{1,10},{15,20},{20,50}}},
		addskilldamage1={
			[1]={{1,321},{2,321}},
			[3]={{1,1},{20,92/2}}
		},
		colddamage_v={
			[1]={{1,10},{20,56},{25,70},{31,4000},{46,4000},{47,50000},{49,50000}},
			[3]={{1,10},{20,56},{25,70},{31,5000},{46,5000},{47,10000},{49,30000}}
		},
	...
	wuxiang_zhan={ --无相斩
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		physicsenhance_p={{{1,45},{15,550},{20,770}}},
		magicenhance_p={{{1,20},{15,20},{25,80},{26,90}}},
		colddamage_v={
			[1]={{1,10},{20,5450},{40,20450},{46,20450},{50,30450},{51,50450}},
			[3]={{1,10},{20,5450},{40,20450},{46,20450},{50,30450},{51,50450}}
		},
		addskillexp1={{{1,0},{2,0}},{{1,1},{20,1}},{{1,0},{2,0}}},
