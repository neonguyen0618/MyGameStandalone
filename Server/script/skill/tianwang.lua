...
SKILLS={
	...
	zhuixing_zhuyue={ --追星逐月
		physicsenhance_p={{{1,50},{15,200},{20,331}}},
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
	...
	zhuifeng_jue={ --追风诀
		physicsenhance_p={{{1,25},{15,140},{20,450}}},
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
